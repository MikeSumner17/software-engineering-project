...
// AYO SECURITY!! SECURITY!?? oh yeah, ain't got none. 
        ...
        if(!$con->connect_error) {$con->query("UPDATE members SET membershiplevel = 'Standard' WHERE barcode ='$barcode'");}
        ?><script>
        alert('Member has been downgraded.'); window.location.href = '../search.html';
        </script><?php
